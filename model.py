...
from tensorflow.keras.models import load_model  # Update this line
...
def main():
    # Load data
    train_data = load_data(r'C:\Users\Blu-Ray\Desktop\mygit\Nada1\graduation-project-sign-language-detection\sign_mnist_train.csv')  # Updated path
    ...
    loaded_model = load_trained_model("sign-language.h5")  # Updated this line to match the saved model name
